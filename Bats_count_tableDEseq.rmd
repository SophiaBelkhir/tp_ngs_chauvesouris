...
# row.names(resUsNameVsd) <- resUsNameVsd$external_gene_name
# resUsNameVsd <- resUsNameVsd[,10:15]
# 
# pheatmap(resUsNameVsd[select,], cluster_rows=TRUE, show_rownames=TRUE,show_colnames=FALSE,
#          cluster_cols=FALSE, annotation_col=samples)
# 
