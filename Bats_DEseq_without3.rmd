...
table(resUsName_wo3$padj <0.05 & resUsName$log2FoldChange>0) #Number of genes significatively UPregulated #521 (with Lib3 was 421)
table(resUsName_wo3$padj <0.05 & resUsName$log2FoldChange<0) #Number of genes significatively DOWNregulated #175 (with Lib3 was 157)
